...
export const register = async (req, res) => {
    try {
        ...
        const userName = typeof (name || fullName) === 'string' ? (name || fullName).trim() : '';
        const userEmail = typeof email === 'string' ? email.trim().toLowerCase() : '';
        const userPhone = typeof (phone || mobileNumber) === 'string'
...
export const login = async (req, res) => {
    try {
        ...
        const inputId = typeof suppliedIdentifier === 'string' ? suppliedIdentifier.trim() : '';
